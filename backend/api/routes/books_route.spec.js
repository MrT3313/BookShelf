...
describe('/books/', function() {
    ...
    describe("POST /", function() {
        ...
        // Test
        it('Add book & return 200 JSON data w/ len(array) === 1', async function() {
            // Prepare Data
            const data = {
                "title": "BLAHH",
                "author": "BLAHH"
    ...
    describe('GET /all', function() {
        it('return 200 JSON data w/ len(array) === 1', async function() {
    ...
    // - Sub Suite - 
    describe('GET /:bookID', function() {
        it(' return 200 JSON data w/ INSTANCE of response.body === "object" ', async function() {
    ...
    // - Sub Suite - 
    describe("PUT /:bookID", function() {
        it('Update Book Title & Author', async function() {
            const updateData = {
                "title": 'updatedTitle',
